...
ggsave(paste0("../../plots/domino/",date,"rocModelAllSettings.pdf"), width=12, height=12)
...
# dfAUCAll <- readRDS("../objects/dfAUCAll20240906.rds")
...
ggplot(dfAUCAll, aes(x=method, y=auc)) +
  ...
  xlab("") + ylab("AUC")
# ggsave("../plots/aucAllSettings.pdf", width=12, height=9)
ggsave(paste0("../../plots/domino/",date,"aucAllSettings.pdf"), width=12, height=9)
```
