...
saveRDS(poisRes_repr, file="../data/poisRes_repressions_transfactor.rds")
```
...
pdf("../plots/bigHeatmapTFActivity_v2.pdf", width=12, height=18)
pheatmap(mu_tc_scaled,
...
saveRDS(poisRes_repr_design10, file="../data/poisRes_repr_design10Cells.rds")
```
...
```{r}
poisRes_repr_design10 <- readRDS("../data/poisRes_repr_design10Cells.rds")
library(scater)
set.seed(44)
...
saveRDS(pHeat, file="../plots/pHeatTFAct.rds")
saveRDS(pDiaux, file="../plots/pDiaux.rds")
saveRDS(pNitro, file="../plots/pNitro.rds")
saveRDS(pDR, file="../plots/pDR.rds")

cowplot::plot_grid(pHeat[[4]], pDiaux, pNitro, pDR, labels=letters[1:4])
ggsave("../plots/compositeFigure.pdf", width=12, height=12)
```
